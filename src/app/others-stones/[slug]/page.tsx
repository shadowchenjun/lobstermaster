  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      <div className="flex items-center gap-2 text-sm text-gray-400 mb-8">
        ...
        <span>/</span>
        <Link href="/others-stones" className="hover:text-brand">他山之石</Link>
        <span>/</span>
      ...
      <div className="mt-16 pt-8 border-t border-gray-100">
        <Link href="/others-stones" className="text-brand font-semibold hover:underline text-sm">
          ← 返回他山之石
        </Link>
      </div>
    </div>
